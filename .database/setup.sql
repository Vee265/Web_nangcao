...
-- Xóa sạch các bảng cũ nếu đã tồn tại để tránh xung đột dữ liệu
...
CREATE TABLE TOPICS (
  ...
  PRIMARY KEY (TId),
  CONSTRAINT FK_MID FOREIGN KEY (Mod_Id) REFERENCES MODULES (MID) ON DELETE CASCADE ON UPDATE CASCADE
);
    
-- 6. Tạo bảng LEARN_PREFERENCE (Bắt buộc có Khóa chính ID tự tăng cho Aiven)
CREATE TABLE LEARN_PREFERENCE (
  id INT AUTO_INCREMENT PRIMARY KEY,
  TPreference VARCHAR(50) NULL,
  APreference VARCHAR(50) NULL,
  Stud_Id VARCHAR(10) NULL,  
  CONSTRAINT FK_SID FOREIGN KEY (Stud_Id) REFERENCES STUDENT (SID) ON DELETE CASCADE ON UPDATE CASCADE
);

-- =========================================================
-- TIẾN HÀNH CHÈN DỮ LIỆU MẪU CHUẨN XÁC
-- =========================================================
...
INSERT INTO LEARN_PREFERENCE (TPreference, APreference, Stud_Id) VALUES
('Online','No Exam','1000'),
('Online','Project','1001'),
('F-2-F','Project','1002'),
